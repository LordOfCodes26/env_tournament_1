...
SIZE_CONFIG: dict[str, dict] = {
    ...
    "2_4_b":  {"lr": 2e-5, "distributed": "ddp", "gpu_count": 2, "use_lora": True,  "use_vllm": True,  "use_4bit": False},
    "4_5_b":  {"lr": 2e-5, "distributed": "ddp", "gpu_count": 2, "use_lora": True,  "use_vllm": True,  "use_4bit": False},
    "5_6_b":  {"lr": 2e-5, "distributed": "ddp", "gpu_count": 2, "use_lora": True,  "use_vllm": True,  "use_4bit": False},
    "6_9_b":  {"lr": 2e-5, "distributed": "ddp", "gpu_count": 4, "use_lora": True,  "use_vllm": True,  "use_4bit": False},
